...
/**
 * Class that uses the cas cookie to verify if the user should validate the ticket on cas server.
 *
 * @author mattos
 */
public class VisibleAuthenticationCookieStrategy implements AuthenticationVerifierStrategy {

	private Logger logger = LoggerFactory.getLogger(getClass());

	private String casCookieName = "TGC";

	public VisibleAuthenticationCookieStrategy() {
	}

	public VisibleAuthenticationCookieStrategy(String cookieName) {
		this.casCookieName = cookieName;
	}

	/**
	 * Verifies if the user already is authenticated looking at the cas cookie.
	 *
	 * @param cookies
	 * @return
	 ...
	 */
	@Override
	public boolean shouldTryToAuthenticate(HttpServletRequest request, Authentication authentication) {
