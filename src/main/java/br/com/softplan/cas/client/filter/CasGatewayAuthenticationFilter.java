...
public class CasGatewayAuthenticationFilter implements Filter, InitializingBean {
	 ...
	 *            - Changes the implementation of the request cache.
	 * @param requestCache
	...
	/**
	 * An implementation of the casAuthenticationEntryPoint that always add the gateway true url parameter
	 *
	 * @author mattos
	 */
	private class CasGatewayAuthenticationEntryPoint extends CasDelegatingAuthenticationEntryPoint {

		public CasGatewayAuthenticationEntryPoint(CasAuthenticationEntryPoint casAuthenticationEntryPoint) {
			super(casAuthenticationEntryPoint);
		}

		@Override
		public String createRedirectUrl(String serviceUrl) {
			return super.createRedirectUrl(serviceUrl) + "&gateway=true";
		}
